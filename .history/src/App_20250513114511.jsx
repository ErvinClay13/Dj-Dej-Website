    ...
    <div className="main-container">
      ...
      <section className="info-section" id="about">
        <div className="info-block">
          ...
          for her seamless blends of house, steppin’ grooves, R&B, and hip-hop, DJ Dej creates soundscapes that move people—literally. Her sets are soulful, upbeat, and rooted in genres like gospel, neo-soul, afrobeats, amapiano, reggae, pop, and Top 100 hits.
